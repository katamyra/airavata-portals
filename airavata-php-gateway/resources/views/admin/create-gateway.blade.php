                ...
                <div class="col-md-offset-2 col-md-8">
                    ...
                    <form id="add-tenant-form" action="{{ URL::to('/') }}/admin/add-new-gateway">
                        ...
                        <div class="form-group required">
                            ...
                            <input type="text" maxlength="50" name="gateway-name" class="form-control" required="required" value="{{ old('gateway-name') }}" />
                        </div>

                        <div class="form-group required">
                            <label class="control-label">Gateway URL</label>
                            <input type="text" name="gateway-url" id="gateway-url" class="form-control" value="{{ old('gateway-url') }}" data-container="body" data-toggle="popover" data-placement="left" data-content="URL to Portal home page or Download URL (for desktop applications) where gateway has been deployed."/>
                        </div>

                        <div class="form-group required">
                            <label class="control-label">Gateway Contact Email</label>
                            <input type="text" name="email-address" class="form-control" required="required" value="{{ old('email-address') }}" />
                        </div>

                        <div class="form-group required">
                            <label class="control-label">Gateway Admin Username</label>
                            <input type="text" name="admin-username" value="{{ old('admin-username') }}" class="form-control" required="required" />
                        </div>
                        ...
                        <div class="form-group required">
                            ...
                            <input type="text" name="admin-firstname" class="form-control" required="required" value="{{ old('admin-firstname') }}" />
                        </div>

                        <div class="form-group required">
                            <label class="control-label">Admin Last Name</label>
                            <input type="text" name="admin-lastname" class="form-control" required="required" value="{{ old('admin-lastname') }}" />
                        </div>

                        <div class="form-group required">
                            <label class="control-label">Admin Email ID</label>
                            <input type="text" name="admin-email" class="form-control" required="required" value="{{ old('admin-email') }}" />
                        </div>

                        <div class="form-group required">
                            <label class="control-label">Project Details</label>
                            <textarea type="text" name="project-details" maxlength="250" id="project-details" class="form-control" required="required"  data-container="body" data-toggle="popover" data-placement="left" data-content="This information will help us to understand and identify your gateway requirements, such as local or remote resources, user management, field of science and communities supported, applications and interfaces, license handling, allocation management, data management, etc... It will help us in serving you and providing you with the best option for you and your research community.">{{ old('project-details') }}</textarea>
                        </div>

                        <div class="form-group required">
                            <label class="control-label">Public Project Description</label>
                            <textarea type="text" name="public-project-description" maxlength="250" id="public-project-description" class="form-control" required="required"  data-container="body" data-toggle="popover" data-placement="left" data-content="This description will be used to describe the gateway in the Science Gateways List. It help a user decide whether or not this gateway will be useful to them.">{{ old('public-project-description') }}</textarea>
                        </div>
